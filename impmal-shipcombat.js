...
Hooks.once("init", async () => {
  ...
  // Pre-load templates
  await loadTemplates([
    // ── Non-role actor pages (unchanged) ─────────────────────────────────
    `modules/${MODULE_ID}/templates/actor/partials/ship-header.hbs`,
    `modules/${MODULE_ID}/templates/actor/tabs/ship-overview.hbs`,
    `modules/${MODULE_ID}/templates/actor/tabs/ship-config.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/npc-ship-header.hbs`,
    `modules/${MODULE_ID}/templates/actor/tabs/npc/npc-ship-body.hbs`,
    `modules/${MODULE_ID}/templates/actor/tabs/npc/npc-ship-config.hbs`,
    `modules/${MODULE_ID}/templates/actor/tabs/npc/npc-ship-movement.hbs`,
    `modules/${MODULE_ID}/templates/actor/tabs/npc/npc-ship-gunner.hbs`,
    `modules/${MODULE_ID}/templates/actor/tabs/npc/npc-ship-ordnance.hbs`,
    `modules/${MODULE_ID}/templates/actor/sheets/torpedo-header.hbs`,
    `modules/${MODULE_ID}/templates/actor/sheets/torpedo-warhead.hbs`,
    `modules/${MODULE_ID}/templates/actor/sheets/torpedo-config.hbs`,
    `modules/${MODULE_ID}/templates/actor/sheets/strike-craft-header.hbs`,
    `modules/${MODULE_ID}/templates/actor/sheets/strike-craft-sheet.hbs`,
    `modules/${MODULE_ID}/templates/actor/sheets/strike-craft-config.hbs`,
    // ── Role tab compositors — 6-player ──────────────────────────────────
    `modules/${MODULE_ID}/templates/actor/tabs/6/captain.hbs`,
    `modules/${MODULE_ID}/templates/actor/tabs/6/ordnance.hbs`,
    `modules/${MODULE_ID}/templates/actor/tabs/6/enginseer.hbs`,
    `modules/${MODULE_ID}/templates/actor/tabs/6/pilot.hbs`,
    `modules/${MODULE_ID}/templates/actor/tabs/6/sensors.hbs`,
    ...
    `modules/${MODULE_ID}/templates/actor/partials/station-header.hbs`,
    // ── Vessel (torpedo / strike-craft) shared partials ───────────────────
    `modules/${MODULE_ID}/templates/actor/partials/vessel-resource-bar.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/vessel-movement-controls.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/vessel-weapon-traits.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/vessel-turn-complete.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/vessel-trait-summary.hbs`,
    // ── Captain partials ──────────────────────────────────────────────────
    `modules/${MODULE_ID}/templates/actor/tabs/5/enginseer.hbs`,
    `modules/${MODULE_ID}/templates/actor/tabs/5/gunner.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/captain-claim-prompt.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/captain-status-bar.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/command-deck-bar.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/combined-core-actions.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/combined-leadership.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/deployed-strike-craft.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/deployed-torpedoes.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/captain-leadership.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/captain-voidshields.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/captain-conditions.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/captain-core-actions.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/captain-hand.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/captain-active-orders.hbs`,
    // ── Ordnance partials ─────────────────────────────────────────────────
    `modules/${MODULE_ID}/templates/actor/partials/ordnance-claim-prompt.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/ordnance-captain-boost.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/ordnance-status-bar.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/ordnance-requisition.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/ordnance-main-actions.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/ordnance-payload.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/ordnance-core-actions.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/ordnance-deployed.hbs`,
    // ── Enginseer partials ────────────────────────────────────────────────
    `modules/${MODULE_ID}/templates/actor/partials/enginseer-claim-prompt.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/enginseer-captain-boost.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/enginseer-status-bar.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/enginseer-core-distribution.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/enginseer-heat-management.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/enginseer-fire-suppression.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/enginseer-hull-repair.hbs`,
    // ── Pilot partials ────────────────────────────────────────────────────
    `modules/${MODULE_ID}/templates/actor/partials/pilot-claim-prompt.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/pilot-captain-boost.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/pilot-status-bar.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/pilot-helm-control.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/pilot-overcharged-actions.hbs`,
    // ── Sensors partials ──────────────────────────────────────────────────
    `modules/${MODULE_ID}/templates/actor/partials/sensors-claim-prompt.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/sensors-captain-boost.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/sensors-status-bar.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/sensors-radar.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/sensors-radar-popout.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/sensors-bda.hbs`,
    `modules/${MODULE_ID}/templates/actor/partials/sensors-abilities-ref.hbs`,
    // ── Gunner partials ───────────────────────────────────────────────────
